            ...
            <form id="add_admin_form">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="organization" class="organization" style="border: none;margin-top: 1%;height: 33px;width: 173%;" required>
                ...
                <div class="row" style="margin-top: 1%;">
                    <div class="col-md-12" style="text-align: right;">
                        ...
                        @endif
                        <a href="{{url('https://procuriot.ioptime.com/admins/list')}}"
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data.success)
                {
                    ...
                    window.location.href = 'https://procuriot.ioptime.com/admins/list';
                }
                if(data.updated){
