...
<script src="{{asset('/assets2/vendors/datatables.net-bs4/dataTables.bootstrap4.js')}}"></script>
...
<script src="{{asset('/assets2/js/data-table.js')}}"></script>
<script src="{{asset('/assets2/js/jquery.dataTables.js')}}"></script>
<script src="{{asset('/assets2/js/dataTables.bootstrap4.js')}}"></script>
