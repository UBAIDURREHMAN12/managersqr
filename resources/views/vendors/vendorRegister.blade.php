...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center">{{ __('Vendor Registration') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('vendorRegistration') }}">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a  class="btn btn-link" href="/vendor/vendor-login">Login</a>
