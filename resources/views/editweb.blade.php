...
@section('content')
    ...
    <div class="col-md-12">
        ...
        <form method="post" action="{{route('update.webcontent',$data->id)}}"  enctype="multipart/form-data">
            ...
            <div class="card">
                ...
                <div class="card-body ">
                    ...
                    @endif
                    <br>
{{--                    <a href="/createQrcode2?id={{$data->id}}" class="btn btn-success btn-md" >Generate Qrcode</a>--}}

{{--                    <a href="{{route('custom.webs',$data->id)}}" target="_blank" class="btn btn-info btn-md">Preview Website</a>--}}

{{--                    <p style="display: none;" id="p1">http://managersqr.managershq.com.au/website/{{$data->id}}</p>--}}


{{--                    <a href="#" class="btn btn-warning btn-md" onclick="copyToClipboard('#p1')">Copy Link</a>--}}
                    @if (count($errors) > 0)
                    ...
                    <div class="row">
                        ...
                        <div class="card mb-1">
                            ...
                            <div class="col-md-12">
                            <div class="form-group bmd-form-group is-filled has-label">
                                <textarea id="editor" name="home">{{$data->home}}</textarea>
                            </div>
                            </div>
                            </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card mb-1">
                            ...
                            @if($data->bg_color!="")
                            <input name="bg_color" value="{{$data->bg_color}}" type="color" class="form-control input-lg"/>
                            @else
                            <input name="bg_color" value="#ffffff" type="color" class="form-control input-lg"/>
                            @endif
                            ...
                            <input name="header_color" value="{{$data->header_color}}" type="color" class="form-control input-lg"/>
                            @else
                            <input name="header_color" value="#ffffff" type="color" class="form-control input-lg"/>
                            @endif
                            <span class="input-group-append">
                            <span class="input-group-text colorpicker-input-addon"><i></i></span></span>
                            </div>
                            ...
                            <div id="cp3" class="input-group colorpicker-component" title="Using color option">
                            @if($data->btn_color!="")
                            <input name="btn_color" value="{{$data->btn_color}}" type="color" class="form-control input-lg"/>
                            @else
                            <input name="btn_color" value="#ffffff" type="color" class="form-control input-lg"/>
                            @endif
                            <span class="input-group-append">
                            <span class="input-group-text colorpicker-input-addon"><i></i></span></span>
                            </div>
                            ...
                            <input name="btn_txt_color" value="{{$data->btn_txt_color}}" type="color" class="form-control input-lg"/>
                            @else
                            <input name="btn_txt_color" value="#000" type="color" class="form-control input-lg"/>
                            @endif
                            <span class="input-group-append">
                            <span class="input-group-text colorpicker-input-addon"><i></i></span></span>
                            </div>
                            ...
                            <input name="heading_color" value="{{$data->heading_color}}" type="color" class="form-control input-lg"/>
                            @else
                            <input name="heading_color" value="#000" type="color" class="form-control input-lg"/>
                            @endif
                            <span class="input-group-append">
                            <span class="input-group-text colorpicker-input-addon"><i></i></span></span>
                            </div>
                            ...
                            <div id="cp3" class="input-group colorpicker-component" title="Using color option">
                            @if($data->footer_bgcolor!="")
                            <input name="footer_bgcolor" value="{{$data->footer_bgcolor}}" type="color" class="form-control input-lg"/>
                            @else
                            <input name="footer_bgcolor" value="#000" type="color" class="form-control input-lg"/>
                            @endif
                            <span class="input-group-append">
                            <span class="input-group-text colorpicker-input-addon"><i></i></span></span>
                            </div>
                            ...
                            <div id="cp3" class="input-group colorpicker-component" title="Using color option">
                            @if($data->footer_txt_color!="")
                            <input name="footer_txt_color" value="{{$data->footer_txt_color}}" type="color" class="form-control input-lg"/>
                            @else
                            <input name="footer_txt_color" value="#ffffff" type="color" class="form-control input-lg"/>
                            @endif
                            <span class="input-group-append">
                            <span class="input-group-text colorpicker-input-addon"><i></i></span></span>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card mb-1">
                            ...
                            <div class="col-md-12">
                            <div class="form-group bmd-form-group is-filled has-label">
                            <input type="text" value="{{$data->fb_link}}" name="fb_link" class="form-control input-lg" placeholder="Facebook Link">
                            </div>
                            </div>
                            <div class="col-md-12">
                            <div class="form-group bmd-form-group is-filled has-label">
                            <input type="text" value="{{$data->insta_link}}" name="insta_link" class="form-control input-lg" placeholder="Instagram Link">
                            </div>
                            </div>
                            <div class="col-md-12">
                            <div class="form-group bmd-form-group is-filled has-label">
                            <input type="text" value="{{$data->twitter_link}}" name="twitter_link" class="form-control input-lg" placeholder="Twitter Link">
                            </div>
                            </div>
                            </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card mb-1">
                            ...
                            <div class="card-body">
                            <a href="{{route('gallery',request()->route('id'))}}" class="btn btn-danger btn-sm">Remove Images</a>
                            <div class="row">
                            ...
                            <div class="custom-file">
                                <input type="file" name="files[]" class="custom-file-input" id="multiImg" multiple="multiple">
                    ...
                    <div class="row">
                        ...
                        <div class="card mb-1">
                            ...
                            <input name="address" value="{{$data->address}}" class="form-control" id="origin-input" placeholder="Address" autocomplete="on">
                            <input type="hidden" name="latitude"  id="origin_latitude" value="{{$data->latitude}}">
                            <input type="hidden" name="longitude" id="origin_longitude" value="{{$data->longitude}}">
                            ...
                            <input name="email" value="{{$data->email}}" placeholder="Add Email" type="email" class="form-control input-lg"/>
                            ...
                            <input id="" name="phone" value="{{$data->phone}}" placeholder="Add Phone Number" type="number" class="form-control input-lg"/>
                            <span class="input-group-append"></span>
                            </div>
                            </div>
                            </div>
                ...
                <div class="card-footer ml-auto mr-auto">
                    ...
                    <a href="http://managersqr.managershq.com.au/load/web/view" style="float: right;" class="btn btn-primary">Back</a>
                </div>
            </div>
        </form>
    </div>
