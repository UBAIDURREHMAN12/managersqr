...
{{--                                            <label>Website</label>--}}
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 " >
                                                                <div class="input-group" title="Plain Text">
                                                                    <input id="plaintexts" name="plaintext"  type="text" class="form-control input-lg"/>
                                                                    <span class="input-group-append">
                                                                  </span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 " >
                                                                <div class="input-group" title="Address">
                                                                    <input name="address" class="form-control" required id="origin-input" placeholder="Address" autocomplete="on">
                                        ...
                                        <form method="post" id="form12" action="/downloadQrcode23">
                                            @csrf
                                            <input type="hidden" value="{{session()->get('property')}}" name="property">
                                            {{--//////////////   this is download 2 button  --}}
                                            <button  value="Download" id="downloadButton" type="submit" class="btn btn-primary mt-3 mb-2 btn-lg btn-block apply-button" >Save & Download 2</button>
                        ...
                        jQuery.ajax({
                            ...
                            success: function(result,xhr){
                                ...
                                if(xhr=='success'){
                                    ...
                                    $.ajax({
                                        url: 'http://managersqr.managershq.com.au/downloadQrcode23',
                                        type: 'post',
