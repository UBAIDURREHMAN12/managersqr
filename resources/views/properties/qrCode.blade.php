...
{{--                                    <div class="card">--}}
{{--                                        <div class="card-header" style="cursor: pointer;" data-toggle="collapse" data-target="#88888888">--}}
{{--                                            <label for="#!">Company Logo</label>--}}
{{--                                            <i style="float: right" class="fa fa-plus angles"></i>--}}
{{--                                        </div>--}}
{{--                                        <div class="card-body collapse" id="88888888">--}}
...
{{--                                    </div>--}}
                                    ...
                                    <div class="card mb-3">
                                            ...
                                            <div  class="card-header" style="cursor: pointer;" id="headingThree" data-toggle="collapse" data-target="#collapseThree">
                                                <i style="background: #F4F8FF;" id="icon-1" class="fas fa-image"></i>
                                        ...
                                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                                            <div class="card-body">
                                                ...
                                                <form id="company_logo_form">
                                                    @csrf
                                                    <input  type="file" id="logo-image" name="image" accept=".jpg, .png">

                                                    <input type="submit" value="Attach Selected Logo" style="margin-top: 2%;">
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <form id="text-setting">
                                        {{--Enter your text --}}
                                        <div class="card mb-3">

                                            <div  class="card-header" style="cursor: pointer;" id="headingThree" data-toggle="collapse" data-target="#collapseFour">
                                                <i style="background: #F4F8FF;" id="icon-1" class="fas fa-pen"></i>
                                            ...
                                            <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div  class="input-group" title="Enter text for line one">
                                                                <input  name="textLine1" id="textLine1"   type="text" maxlength="40" placeholder="Maximum 40 characters" class="form-control input-lg"/>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 " >
                                                            <div class="input-group" title="Enter text for line two">
                                                                <input  name="textLine2" id="textLine2"  maxlength="40" placeholder="Maximum 40 characters" type="text" placeholder="Scan this!" class="form-control input-lg"/>
    ...
    <span class="input-group-text colorpicker-input-addon"><i></i></span>
                                    ...
                                    {{--Qr settings--}}
                                    <div class="card mb-3">
{{--                                        <div style="height: 45px;" class="card-header" style="cursor: pointer;" id="headingOne" data-toggle="collapse" data-target="#collapseOne">--}}
{{--                                            <i style="background: #F4F8FF;" class="fas fa-cogs"></i>--}}
{{--                                            <lable>Qr Settings</lable>--}}
{{--                                            <i style="float: right" class="fa fa-plus angles"></i>--}}
{{--                                        </div>--}}

                                        <div  class="card-header" style="cursor: pointer;" id="headingThree" data-toggle="collapse" data-target="#collapseOne">
                                            <i style="background: #F4F8FF;" id="icon-1" class="fas fa-cogs"></i>
                                            <lable>Qr Settings</lable>
                                            <i style="float: right" class="fa fa-plus angles"></i>
                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <form method="post" action="/fileuploader" enctype="multipart/form-data">
                                                            ...
                                                            <input id="demo-image" type="file" accept=".jpg, .png">
                                    ...
                                    <form id="add-link">
                                        <div class="card mb-3">
                                            ...
                                            <div  class="card-header" style="cursor: pointer;" id="headingThree" data-toggle="collapse" data-target="#collapseFive">
                                                <i style="background: #F4F8FF;" id="icon-1" class="fas fa-link"></i>
...
{{--                                                    </div>--}}
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div  class="input-group" title="Enter bottom title">
                                                            <input  name="title" id="title"  maxlength="40" placeholder="Maximum 40 characters"  type="url" placeholder="Visit US" class="form-control input-lg"/>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div  class="input-group" title="Enter bottom text">
                                                            <input  name="link"  id="uuuuu"  type="url" placeholder="Enter text here" class="form-control input-lg"/>
                                        ...
                                        <div class="card mb-3">
                                            <div  class="card-header" style="cursor: pointer;" id="headingSix" data-toggle="collapse" data-target="#collapseSix">
                                                <i style="background: #F4F8FF;"  class="fas fa-paint-brush" ></i>
                                            ...
                                            <form method="post" action="/downloadQrcode">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="text-align: left;">
                                                        <button type="button" class="btn btn-success mt-4 mb-2 btn-lg btn-block apply-button" style="background: darkblue;" id="applyButton" onclick="generateQr()">Apply</button>
                                                    </div>
                                                    <div class="col-md-12" style="text-align: left;">
                                                        <button  onclick="hideButton()" value="Download" id="downloadButton"
                                                                 type="submit" class="btn btn-primary mt-3 mb-2  apply-button" disabled>Save & Download</button>
                                                    </div>
                                                </div>
                                    ...
                                    @else
                                            ...
                                            <div class="col-md-12">
                                                <button type="button" class="btn btn-info mt-4 mb-2   apply-button" style="width: 100% !important;background: darkblue;" id="applyButton" onclick="generateQr()">Apply</button>
                                            </div>
                                            <div class="col-md-12" style="text-align: left;">
                                                <a  href="/properties/create" onclick="hideButton()"
                                                    id="downloadButton" type="submit" class="btn btn-primary mt-3 mb-2  apply-button setupproperty-button"
                                                    style="width: 100% !important;pointer-events: none;">Setup Property</a>
                                            </div>
            ...
            color: #fff;
            line-height: 1.5;
            background: #012D52;" class=" col-md-12">
                                <div class="row" >
                                    <div class="box text col-md-6">
                                        <img class="d-block mx-auto " src="/public/logimage.png"  alt="" >
                                    </div>
                                </div>
    ...
    bottom: 20px;    font-size: 1vw;">www.example.com</small>
        ...
        <!-- MDB core JavaScript -->
            ...
            <script>
                ...
                function generateQr() {
                    ...
                    var bottomText = $("#uuuuu").val();

                    if(/^(http|https|ftp):\/\/[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/i.test(bottomText)){

                        $('#form_result').html();
                        html = '<div class="alert alert-danger">Your not allow to enter url in bottom text</div>';

                       $('#form_result').html(html);

                    }

                    if (bottomText.startsWith('www') || bottomText.startsWith('http')) {
                        $('#form_result').html();

                        html = '<div class="alert alert-danger">Your not allow to enter website address in bottom text</div>';
                    ...
                    var form4 = $('#company_logo_form').serializeArray();

                    // var data1 = $("#company_logo_form");
                    //
                    ...
                    jQuery.ajax({
                        url: '/generateQr',
                        method: 'post',
                        data:{'form':form,'form2':form2,'form3':form3,'form4':form4,'eye':eye,'link':link,'property':property,"_token": "{{ csrf_token() }}"},
                    ...
                    $(".setupproperty-button").css('pointer-events','');
            ...
            <script>
                ...
                $("#textLine1").keydown((e)=>{
                    ...
                    if(e.keyCode == 8){
                        e.preventDefault();
                        var d = $("#textLine1").val();
                        $("#textLine1").val(d.slice(0,-1));
                    }
                });

                $("#textLine1").keydown(function(event){
                ...
                $("#textLine2").keydown((e)=>{
                    ...
                    if(e.keyCode == 8){
                        e.preventDefault();
                        var d = $("#textLine2").val();
                        $("#textLine2").val(d.slice(0,-1));
                    }
                });

                $("#textLine2").keydown(function(event){
                    var userGetData = event.which;
                    // allow letters and whitespaces only.
                    if(!(userGetData >= 65 && userGetData <= 120) && (userGetData != 32 && userGetData != 0)) {
                        event.preventDefault();
                ...
                $("#uuuuu").keydown((e)=>{
                    ...
                    if(e.keyCode == 8){
                        e.preventDefault();
                        var d = $("#uuuuu").val();
                        $("#uuuuu").val(d.slice(0,-1));
                    }
                });
                $("#uuuuu").keydown(function(event){
                    var userGetData = event.which;
                    // allow letters and whitespaces only.
                    if(!(userGetData >= 65 && userGetData <= 120) && (userGetData != 32 && userGetData != 0)) {
                        event.preventDefault();
            ...
            <script>
                ...
                //         type: 'post',
                //         dataType: 'json',
                //         data: $('form#company_logo_form').serialize(),
                //         success: function(data) {
                //
                //         }
                //     });
                ...
                $('#company_logo_form').on('submit', function(event){
                    event . preventDefault();
                        $.ajax({
                            url:"/save/logo",
                            method:"POST",
        ...
        <a href="https://easypaystg.easypaisa.com.pk/tpg/?storeId=1&orderId=6&transactionAmount=500.0&mobileAcc
ountNo=03698965698&emailAddress=test@test.com&transactionType=InitialRequest&tokenExpiry=20
